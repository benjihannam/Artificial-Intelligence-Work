...
public class ChessClient extends Application {
	...
	public void start(Stage primaryStage) {
		...
		moveMaker[Chess.BLACK] = new AIMoveMaker(new Minimax());
		//moveMaker[Chess.BLACK] = new AIMoveMaker(new AlphaBetaMiniMax());
		//moveMaker[Chess.WHITE] = new TextFieldMoveMaker();
		moveMaker[Chess.WHITE] = new AIMoveMaker(new AlphaBetaMiniMax());
	...
	private class GameHandler implements EventHandler<ActionEvent> {
		...
		public void handle(ActionEvent e) {
            ...
            MoveMaker other = moveMaker[num];

			if (mover.getState() == Worker.State.READY && other.getState() == Worker.State.READY) {
